...
class NeighborhoodDataset(pyg.data.InMemoryDataset):
    ...
    def process(self):
        ...
        print("start sampling neighbors...")
        self.logger.write('Start Sampling Neighbors.')
        start_sampling_neighs = time.time()
        # sample neighs
        ...
        self.logger.write('Neighbors Sampling Done.')
        # convert to pyg graph
        print("converting to pyg graph")
        self.logger.write('Start Converting to PYG Graph.')
        neighs_pyg = []
        ...
        print("sampling neighbors and save done, time: ", time.time() - start_sampling_neighs)
        self.logger.write('Conversion to PYG Graph Done.')
